...
local menu_elements =
{
    ...
    targeting_mode     = combo_box:new(0, get_hash(my_utility.plugin_label .. "withering_fist_targeting_mode")),
    use_as_filler_only = checkbox:new(true, get_hash(my_utility.plugin_label .. "withering_fist_use_as_filler_only")),
