...
local menu_elements =
{
    ...
    targeting_mode     = combo_box:new(0, get_hash(my_utility.plugin_label .. "thrash_targeting_mode")),
...
local spell_data_thrash = spell_data:new(
    ...
    true,                                 -- has_collision
    my_utility.abilities.spell_id_thrash, -- spell_id
...
local function logics(target)
    ...
    local is_logic_allowed = my_utility.is_spell_allowed(
        ...
        my_utility.abilities.spell_id_thrash);
