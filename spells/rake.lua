...
local menu_elements =
{
    ...
    main_boolean   = checkbox:new(true, get_hash(my_utility.plugin_label .. "rake_main_bool")),
    targeting_mode = combo_box:new(0, get_hash(my_utility.plugin_label .. "rake_targeting_mode")),
}
