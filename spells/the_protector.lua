...
local menu_elements =
{
    ...
    main_boolean     = checkbox:new(true, get_hash(my_utility.plugin_label .. "main_boolean_the_protector")),
    ...
    min_max_targets  = slider_int:new(0, 30, 5, get_hash(my_utility.plugin_label .. "min_enemy_count_the_protector")),
